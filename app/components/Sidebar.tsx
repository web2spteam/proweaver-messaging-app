        ...
        <ul className=" space-y-8">
          <li className="flex items-center justify-between pe-5">
            <div className="flex items-center space-x-4">
              ...
              <span className="text-2xl font-semibold text-cyan-400">Notifications</span>
            </div>
            <span className="flex size-8 items-center justify-center rounded-full border border-red-500 bg-transparent text-sm font-bold text-red-500">
              1
            </span>
          </li>
