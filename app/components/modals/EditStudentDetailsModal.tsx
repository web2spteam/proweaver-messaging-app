...
interface FormData {
  id_number: number | string | undefined;
  first_name: string;
  middle_name: string;
  last_name: string;
  birthdate: string;
...
const EditStudentDetailsModal: FC<ModalProps> = ({
  isOpen,
  onClose,
  studentID,
}) => {
  ...
  const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    let formData: FormData = {
      ...
      middle_name: midName,
      last_name: lastName,
      birthdate: birthdate, // Ensure it's always a string
      gender: gender,
              ...
              <div className="space-y-6 p-6">
                ...
                <div className="grid grid-cols-3 gap-6">
                  ...
                  <div id="customDatePickerContainer">
                    ...
                    <div className="relative max-w-sm">
                      ...
                      <Datepicker
                        ...
                        color="blue"
                        value={birthdate} // Ensure it's a Date object or null
                  ...
                  <div>
                    ...
                    <select
                      id="gender"
                      value={gender} // Set the value of the select to the gender state
                      onChange={(e) => {
